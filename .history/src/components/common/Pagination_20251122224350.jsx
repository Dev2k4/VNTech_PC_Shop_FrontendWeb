...
const Pagination = ({ currentPage, totalPages, onPageChange }) => {
    // Giới hạn số lượng trang hiển thị (Window size)
    const SIBLING_COUNT = 5;

    // Nếu tổng số trang <= 1 thì ẩn luôn
    ...
    const getVisiblePages = () => {
        ...
        // Điều chỉnh lại nếu ở những trang cuối (để luôn hiển thị đủ 5 trang)

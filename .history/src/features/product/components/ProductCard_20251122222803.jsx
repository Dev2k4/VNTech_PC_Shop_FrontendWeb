    ...
    return (
        <Box 
            ...
            _hover={{ 
                ...
                bg: "apple.cardHover", 
                boxShadow: "0 20px 30px rgba(255, 255, 255, 0.6)" 
            }}
            position="relative"
            h="420px" 
            display="flex"
            ...
            <Link to={`/products/${id}`} style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                >
                    <Image 
                        ...
                        _groupHover={{ transform: 'scale(2.1)' }}
                    />
                </Flex>

       
                <VStack p={5} align="center" spacing={1} bg="apple.card" zIndex="1">
                    <Text fontSize="xsm" fontWeight="bold" color="#d46b08" textTransform="uppercase" letterSpacing="1px">

...
    Badge, VStack, HStack, Spinner, Divider, useToast, Table, Tbody, Tr, Td // <-- IMPORT THÊM CÁC THÀNH PHẦN TABLE
...
    
    // Lấy hàm addToCart từ Context (đã fix)
...
                            </Box>
                            ...
                            {/* --- BẢNG THÔNG SỐ KỸ THUẬT SẼ ĐƯỢC THÊM TẠI ĐÂY --- */}
...
                </Grid>
                ...
                {/* THÔNG SỐ KỸ THUẬT ĐẶT DƯỚI DẠNG NỔI BẬT */}
                <Box mt={20} pb={20}>
                    <Heading as="h2" size="xl" mb={8} textAlign="center" fontWeight="extrabold">
                        Thông số kỹ thuật chi tiết
                    </Heading>
                    {product.specifications && product.specifications.length > 0 ? (
                        <SpecificationTable specifications={product.specifications} />
                    ) : (
                        <Text textAlign="center" color="gray.500">Thông số kỹ thuật đang được cập nhật.</Text>
                    )}
                </Box>

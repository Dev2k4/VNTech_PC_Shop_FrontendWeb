...
import {
  ...
  Tbody,
  Tr,
  Td, // <-- Giữ nguyên các imports cần thiết
...
const ProductDetailPage = () => {
    ...
    const fetchProduct = async () => {
      ...
      try {
        ...
        if (res && res.data) {
          setProduct(res.data);
          const mainImg =
            res.data.images?.find((i) => i.isMain)?.imageUrl ||
  ...
  if (loading)
    return (
      <Flex justify="center" h="50vh" align="center">
        <Spinner size="xl" color="apple.blue" />
      </Flex>
    );
  if (!product)
    return (
  ...
  // Khai báo SpecificationTable (Tĩnh)
  const productSpecs = product.specifications || [];
  // Giả sử Backend trả về Reviews trong ProductResponseDto (nếu chưa có thì cần thêm vào)
  ...
  return (
    <Box bg="apple.bg" minH="100vh" py={10} color="white">
      ...
      <Container maxW="container.xl">
                       {/* PHẦN TRÊN: ẢNH & NÚT MUA (GIỮ NGUYÊN) */}           
           {" "}
        <Grid
        ...
        >
          ...
          <Box>
                                   {" "}
            {/* Ảnh Lớn & List ảnh nhỏ (Code giữ nguyên) */}
            <Flex
              bg="black"
              borderRadius="3xl"
        ...
        >
          ...
          <Box>
            <Heading as="h2" size="xl" mb={6} fontWeight="700">

...
import OtpForm from '../components/OtpForm'; // Đảm bảo đúng file này
...
const RegisterPage = () => {
    ...
    const handleResendOtp = async () => {
        ...
        try {
            // Logic gửi lại (Backend tự resend nếu email đã tồn tại)
    ...
    const handleVerifyOtp = async (otp) => {
        ...
        try {
            ...
            toast({ title: "Xác thực thất bại", description: "OTP không đúng", status: "error" });
        } finally {
            setIsLoading(false);
        }
    };
